...
function generateFeatureFields({
  ...
  return featuresForm.values.features.map((_i, trueFeatureIndex, featureArray) => {
    ...
    return (
      <Group key={featureIndex} mt="xl">
        <TextInput
          ...
          onChange={(event) => {
            featuresForm.setListItem('features', featureIndex, {
            ...
            //@ts-ignore
            featuresForm.clearFieldError(`features.${featureIndex}.feature`);
          }}
        />
        <ActionIcon
          sx={{ alignSelf: 'center' }}
